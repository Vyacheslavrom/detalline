...
// стандартные функции календар€

/** добавл€ет событи€ мыши */
...
Calendar._checkCalendar = function(ev) {
	...
	if (el == null) {
		// вызывает функции закрыти€ календар€
...
/** массив количества дней в мес€це. */
...
/** возвращает число дней в текущем мес€це */
