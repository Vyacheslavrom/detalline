...
';
				...
				$this->Sendmail->subject = 'Новый запрос запчастей на сайте DETALLINE.RU';
				$this->Sendmail->message = 
'Уважаемый поставщик,
								
Мы благодарим Вас за интерес, проявленный к on-line магазину автозапчастей DETALLINE.RU.

Вам пришел запрос запчастей. Ответить на него можно в разделе "Запросы Покупателей" в личном кабинете на сайте нашего магазина автозапчастей DETALLINE.RU. 
...
Вам пришел ответ на Ваш запрос запчастей. Просмотреть его можно в личном кабинете в разделе "Ваши Запросы Запчастей" на сайте нашего магазина автозапчастей detalline.ru
